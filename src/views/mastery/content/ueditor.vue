    ...
    <div>
      ...
      >
        <el-row :gutter="24">
          <el-col :span="12">
            <el-form-item label="简称:" >
              <el-input style="width:300px" v-model="mondify.abbreviation"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="全称:" >
              <el-input style="width:300px" v-model=mondify.articleTitle></el-input>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="6">
            <el-form-item label="文章类型:" prop="value">
              <el-select v-model="mondify.categoryId" placeholder="请选择">
                <el-option
        ...
        <el-form-item label="简述" >
          <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="mondify .sketch"></el-input>
        </el-form-item>
      </el-form>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      options: [{
          ...
          value: '140',
          label: '技术能力-服务能力-咨询服务'
        }, {
          value: '150',
          label: '技术能力-服务能力-运维服务'
        }, {
          value: '160',
          label: '技术能力-服务能力-人员技术服务'
        }, {
          value: '170',
          label: '公司简介'
        }, {
  ...
  methods: {
      ...
      if(type == 50){
        ...
        return '技术能力-服务能力-运维服务'
      } else if (type == 160) {
        return '技术能力-服务能力-人员技术服务'
      } else if (type == 170) {
        return '公司简介'
      } else if (type == 180) {
        return '企业文化'
    ...
    showData() {
      axios
        .post("/plat/web/modifyArticle", {
           articleId:this.mondify.articleId,
           abbreviation:this.mondify.abbreviation,
           articleTitle:this.mondify.articleTitle,
          //  categoryId: this.mondify.categoryId,
           sketch: this.mondify.sketch,
           content:this.mondify.content
        })
        .then(res => {
          console.log(res);
        });
